...
@Component({
  selector: 'app-early-warning-system',
  templateUrl: './early-warning-system.component.html',
  styleUrls: ['./early-warning-system.component.scss']
})
export class EarlyWarningSystemComponent implements OnInit {
