...
@Component({
  ...
  styleUrls: ['./profit-margin-report.component.scss']
})

export class ProfitMarginReportComponent implements OnInit, AfterViewInit, OnDestroy, AfterViewChecked {
  ...
  getLists() {
    ...
    this.$service.getProfitMarginReports(queryParams)
      .pipe(takeUntil(this.unsubscribe$))
      .subscribe(results => {
