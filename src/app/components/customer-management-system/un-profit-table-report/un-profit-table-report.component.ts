...
@Component({
  selector: 'app-un-profit-table-report',
  templateUrl: './un-profit-table-report.component.html',
  styleUrls: ['./un-profit-table-report.component.scss']
})

export class UnProfitTableReportComponent implements OnInit, AfterViewInit, OnDestroy, AfterViewChecked {
  ...
  public cols = [
    ...
    {field: 'invoiceId', header: 'invoiceId', typeField: 'text'},
    {field: 'categoryId', header: 'categoryId', typeField: 'text'},
    {field: 'productName', header: 'Sản phẩm', typeField: 'text', width: 300},
    {field: 'lastBuyPrice', header: 'lastBuyPrice', typeField: 'decimal'},
    {field: 'sellPrice', header: 'sellPrice', typeField: 'decimal'},
    {field: 'actualProfit', header: 'actualProfit', typeField: 'decimal'},
    {field: 'standardProfit', header: 'standardProfit', typeField: 'decimal'},
    {field: 'maxProfit', header: 'maxProfit', typeField: 'decimal'},
    {field: 'minProfit', header: 'minProfit', typeField: 'decimal'},
    {field: 'purchaseDate', header: 'purchaseDate', typeField: 'text'},
  ...
  public getRowId: GetRowIdFunc = (params: GetRowIdParams) => {
    return params.data.productId + params.data.invoiceId;
  };
  ...
  getLists() {
    ...
    this.$service.getUnprofitableReports(queryParams)
      .pipe(takeUntil(this.unsubscribe$))
      .subscribe(results => {
