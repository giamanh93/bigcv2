...
@NgModule({
    ...
    declarations: [FinancialControlSystemComponent, ReviewRevenueWithFlowOfMoneyComponent, ReviewPaymentWithSupplierComponent, ReviewSupplierDebtComponent, CustomerDebtComponent]
})
